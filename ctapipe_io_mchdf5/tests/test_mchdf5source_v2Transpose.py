...
example_file_path = resource_filename(
	...
	os.path.join('tests',
		'resources',
		'gamma_test_large_hipecta_v2Transpose.h5'
	)
)
...
# 			break
#
# 	assert(hipe_event.meta['origin'] == "mchdf5v2PixelSlice")
...
# 	from ctapipe_io_mchdf5 import MCHDF5EventSourceV2Transpose
#
# 	n_events = 10
# 	inputfile_reader = MCHDF5EventSourceV2Transpose(input_url=example_file_path)
# 	i = 0
...
# 	from ctapipe_io_mchdf5 import MCHDF5EventSourceV2Transpose
# 	assert MCHDF5EventSourceV2Transpose.is_compatible(example_file_path)
